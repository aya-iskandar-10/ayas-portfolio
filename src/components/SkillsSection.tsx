...
const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Angular', icon: <Globe className="w-5 h-5" /> },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Firebase', icon: <Server className="w-5 h-5" /> },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'CI/CD', icon: <Workflow className="w-5 h-5" /> },
      { name: 'Postman', icon: <Globe className="w-5 h-5" /> },
